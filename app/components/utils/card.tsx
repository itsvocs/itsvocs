...
export const Card: React.FC<PropsWithChildren> = ({ children }) => {
  const mouseX = useSpring(0, { stiffness: 500, damping: 200 });
  const mouseY = useSpring(0, { stiffness: 500, damping: 200 });
  ...
  return (
    <div
      ...
      <div className="pointer-events-none">
        ...
        <motion.div
          className="absolute inset-0 z-10  bg-gradient-to-br opacity-100  via-blue-500/20  transition duration-1000 group-hover:opacity-50 "
          style={style}
        />
        <motion.div
