      ...
      <div className="relative flex flex-1 flex-col items-center justify-center">
        ...
        <div className="max-w-2xl text-center">
          ...
          <div className="mt-6 text-base leading-7 text-slate-300">
            Votre message précieux nous est parvenu avec succès. Soyez assuré
            que notre équipe dévouée est déjà en action pour vous apporter une
            réponse personnalisée dans les plus brefs délais.
          </div>
          <Link
      ...
      <footer className="relative shrink-0 mt-32">
        <div className="relative z-10 flex flex-none items-start justify-center">
          ...
          <p className="ml-6 max-w-lg flex-auto text-sm text-slate-300 font-light">
            <span className="font-semibold text-green-500/75">
              Comment nous vous contactérons?
            </span>{" "}
            Restez à l'affût de votre boîte de réception, car nous avons hâte de
            vous apporter une solution adaptée à vos besoins. Merci encore pour
            votre confiance et votre patience.
          </p>
        </div>
      </footer>
    </div>
